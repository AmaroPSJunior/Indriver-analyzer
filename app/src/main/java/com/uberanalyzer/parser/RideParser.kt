...
object RideParser {
    ...
    private val LOGRADOURO_PREFIXES = listOf(
        "rua", "r.", "r ", "avenida", "av.", "av ", "alameda", "al.", "al ", "praça", "praca", "pça", "pça.", "pç.",
        "estrada", "est.", "rodovia", "rod.", "servidão", "servidao", "serv.", "viaduto", "vd.", "largo", "lg.",
        "ponte", "passagem", "beco", "viela", "quadra", "qd", "qd.", "trecho", "acesso", "marginal",
        "vila", "vl.", "jardim", "jd.", "parque", "pq.", "condomínio", "condominio", "residencial", "res.",
        "bairro", "chácara", "chacara", "sítio", "sitio", "loteamento"
    )
