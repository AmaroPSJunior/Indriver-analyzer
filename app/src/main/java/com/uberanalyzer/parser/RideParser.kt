...
object RideParser {
    ...
    private fun isValidAddressLine(line: String): Boolean {
        ...
        if (line.contains("★") || line.startsWith("R$")) return false
        ...
        return (startsWithLogradouro || (hasAddressNumberOrPunctuation && hasStreetOrLandmark) || (hasStreetOrLandmark && line.length in 6..120))
    }
