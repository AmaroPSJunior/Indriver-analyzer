...
class SettingsManager(context: Context) {
    ...
    fun getMaxRoutes(): Int = prefs.getInt(KEY_MAX_ROUTES_VALUE, DEFAULT_MAX_ROUTES).coerceIn(1, 10)
    fun setMaxRoutes(value: Int) = prefs.edit().putInt(KEY_MAX_ROUTES_VALUE, value.coerceIn(1, 10)).apply()
