...
class OverlayService : Service() {
    ...
    override fun onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val ch = NotificationChannel("indrive_ovl", "inDriver Acessibilidade", NotificationManager.IMPORTANCE_LOW)
            getSystemService(NotificationManager::class.java).createNotificationChannel(ch)
            val n = NotificationCompat.Builder(this, "indrive_ovl")
                .setContentTitle("inDriver Inspector de Acessibilidade")
                .setContentText("Hierarquia de nós de acessibilidade ativa")
    ...
    private fun showJsonPopup(i: Intent, r: ScoreRating) {
        ...
        val rawText = i.getStringExtra(EXTRA_JSON_PAYLOAD) ?: createDefaultSampleJson(i)
        val hierarchyText = com.uberanalyzer.model.AccessibilityHierarchyFormatter.formatJsonToHierarchy(rawText)
        ...
        // --- Accessibility Hierarchy Scrollable View ---
        ...
        val copyBtn = Button(this).apply {
            ...
            setOnClickListener {
                ...
                val clip = ClipData.newPlainText("inDrive_Accessibility_Hierarchy", hierarchyText)
                clipboard.setPrimaryClip(clip)
                Toast.makeText(applicationContext, "✅ Hierarquia de Acessibilidade copiada!", Toast.LENGTH_SHORT).show()
            }
        }
