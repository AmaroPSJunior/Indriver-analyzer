                ...
                card.innerHTML = \`
                    ...
                    <div class="mt-2.5 pt-2 border-t border-slate-800/80 flex items-center justify-between text-[11px]">
                        ...
                        <div class="flex items-center gap-1.5" onclick="event.stopPropagation();">
                            <button onclick="acceptRide(${r.id})" class="px-3 py-1 rounded bg-green-600 hover:bg-green-500 text-white font-extrabold text-[11px] shadow transition flex items-center gap-1">
